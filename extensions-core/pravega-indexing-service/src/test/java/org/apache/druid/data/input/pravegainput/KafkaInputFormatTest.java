...
{
  private PravegaEventEntity inputEntity;
  ...
  public void testWithHeaderKeyAndValue() throws IOException
  {
    ...
    inputEntity = new PravegaEventEntity(new ConsumerRecord<byte[], byte[]>(
  ...
  public void testWithMultipleMixedRecords() throws IOException
  {
    ...
    Headers headers = new RecordHeaders(SAMPLE_HEADERS);
    SettableByteEntity<PravegaEventEntity> settableByteEntity = new SettableByteEntity<>();
    ...
    for (int i = 0; i < keys.length; i++) {
      ...
      inputEntity = new PravegaEventEntity(new ConsumerRecord<>(
          "sample", 0, 0, timestamp,
          null, null, 0, 0,
  ...
  private SettableByteEntity<PravegaEventEntity> newSettableByteEntity(PravegaEventEntity kafkaRecordEntity)
  {
    SettableByteEntity<PravegaEventEntity> settableByteEntity = new SettableByteEntity<>();
