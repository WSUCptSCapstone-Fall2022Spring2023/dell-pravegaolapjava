...
public class PravegaIndexTask extends SeekableStreamIndexTask<String, ByteBuffer, ByteEntity>
{
  ...
  protected PravegaEventSupplier newTaskRecordSupplier()
  {
    ...
    try {
      ...
      PravegaIndexTaskIOConfig pravegaIndexTaskIOConfig = (PravegaIndexTaskIOConfig) super.ioConfig;
      final Map<String, Object> props = new HashMap<>(pravegaIndexTaskIOConfig.getConsumerProperties());

      return new PravegaEventSupplier(props, configMapper, pravegaIndexTaskIOConfig.getConfigOverrides());
    }
    finally {
